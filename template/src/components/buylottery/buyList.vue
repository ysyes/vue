  ...
  <section>
    <div class="mbx">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>内参在线节目</el-breadcrumb-item>
      </el-breadcrumb>
      <div style="float: right; ">
        <el-button type="primary"  @click="$router.push('/buy/add')">添加</el-button>
      </div>
    </div>
    <!--工具条-->
    ...
    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          <el-button type="primary" @click="$router.push('/buy/edit')">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
