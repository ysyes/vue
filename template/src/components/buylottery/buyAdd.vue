<template>
	<section>
		<div class="mbx">
			...
			<el-breadcrumb separator-class="el-icon-arrow-right">
			  ...
			  <el-breadcrumb-item  :to="{ path: '/buy/list' }">内参在线节目</el-breadcrumb-item>
			  <el-breadcrumb-item>添加</el-breadcrumb-item>
			</el-breadcrumb>
      <div style="float: right; ">
        <el-button type="primary"  @click="$router.push('/buy/list')">返回</el-button>
      </div>
		</div>
    ...
    <el-form-item label="上传：">
      <input type="file" />
		...
		<el-form-item>
      <el-button @click.native.prevent  @click="$router.push('/buy/list')">取消</el-button>
