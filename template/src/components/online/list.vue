  ...
  <section>
    <div class="mbx">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>体彩在线节目</el-breadcrumb-item>
      </el-breadcrumb>
      <div style="float: right; ">
        <el-button type="primary"  @click="$router.push('/online/add')">添加</el-button>
      </div>
    </div>
    <!--工具条-->
    ...
    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column type="index"  label="标题"></el-table-column>
      <el-table-column  prop="name" label="日期" :to="{ path: '/info' }">
      </el-table-column>
      <el-table-column prop="realName" label="期次">
      </el-table-column>
      <el-table-column prop="web" label="上传封面">
      </el-table-column>
      <el-table-column prop="phone" label="类型">
      </el-table-column>
      <el-table-column prop="type" label="视频URL">
      </el-table-column>
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button type="primary" @click="online">上架</el-button>
          <!--<el-button >下架</el-button>-->
          <el-button type="primary" @click="$router.push('/online/edit')">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
